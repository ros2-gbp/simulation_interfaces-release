...
%global pkg_name simulation_interfaces
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-simulation-interfaces
Version:        2.1.0
Release:        3%{?dist}
...
%changelog
* Wed Apr 29 2026 Adam Dabrowski <adam.dabrowski@robotec.ai> - 2.1.0-3
- Autogenerated by Bloom

* Tue Apr 28 2026 Adam Dabrowski <adam.dabrowski@robotec.ai> - 2.1.0-2
- Autogenerated by Bloom

* Tue Apr 21 2026 Adam Dabrowski <adam.dabrowski@robotec.ai> - 2.1.0-1
- Autogenerated by Bloom
